...
#define SEG_GPU_DVFS_FREQ1			(800000)	/* KHz */
#define SEG_GPU_DVFS_FREQ2			(800000)	/* KHz */
#define SEG_GPU_DVFS_FREQ3			(770000)	/* KHz */
#define SEG_GPU_DVFS_FREQ4			(760000)	/* KHz */
#define SEG_GPU_DVFS_FREQ5			(750000)	/* KHz */
#define SEG_GPU_DVFS_FREQ6			(740000)	/* KHz */
#define SEG_GPU_DVFS_FREQ7			(730000)	/* KHz */
#define SEG_GPU_DVFS_FREQ8			(726000)	/* KHz */
#define SEG_GPU_DVFS_FREQ9			(719000)	/* KHz */
#define SEG_GPU_DVFS_FREQ10			(717000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT0		(90000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(87500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(85000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(82500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT4		(80000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT5		(77500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT6		(75000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT7		(74375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT8		(73125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT9		(71875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT10		(70625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT11		(70000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT12		(68750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT13		(67500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT14		(66250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT15		(65625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT16		(65000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT17		(64375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT18		(63750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT19		(63125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT20		(61875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT21		(61875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT22		(61250)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT23		(60625)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT24		(60000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT25		(59375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT26		(59375)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT27		(58750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT28		(58125)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT29		(57500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT30		(56875)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT31		(56250)		/* mV x 100 */

#define SEG_GPU_DVFS_VSRAM0		(100000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(97500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(95000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(92500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(90000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(87500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(85000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(84375)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(83125)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM9		(81875)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM10	(80625)		/* mV x 100 */
